...
export const Trait = {
    ...
    [t.fieldImaginarySpace]: 'Imaginary Space',
    [t.fieldShore]: 'Shore',
    ...
    [t.feminineLookingServant]: 'Feminine-looking Servant',
    [t.ghost]: 'Ghost',
    [t.giant]: 'Giant',
    [t.golem]: 'Golem',
    [t.hand]: 'Hand',
    ...
    [t.human]: 'Human',
    [t.humanoid]: 'Humanoid',
    [t.hominidaeServant]: 'Hominidae Servant',
    [t.illya]: 'Illya',
    [t.king]: 'King',
    [t.lamia]: 'Lamia',
    [t.nobu]: 'Nobu',
...
export const TargetType = {
    ...
    [tType.ENEMY_ONE_NO_TARGET_NO_ACTION]: 'one last dealt damage to self',
    [tType.ENEMY_OTHER]: '',
    ...
    [tType.PT_ONE_HP_LOWEST_RATE]: 'ally with lowest HP percentage',
    [tType.PT_ONE_HP_LOWEST_VALUE]: 'ally with lowest HP',
    [tType.PT_SELF_AFTER]: '',
...
export const BuffTypes = {
    ...
    [bType.GUTS]: 'Guts',
    [bType.GUTS_FUNCTION]: 'Trigger skill on Guts',
